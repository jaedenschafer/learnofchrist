    ...
    <>
      ...
      <section className="pt-16 pb-10 sm:pt-24 sm:pb-14 px-5">
        <div className="max-w-2xl mx-auto text-center">
          <h1 className="text-[2.5rem] sm:text-[3.25rem] font-bold tracking-tight leading-[1.05] text-[color:var(--color-label)] mb-4">
            Study the Bible,<br />understand Jesus.
          </h1>
          <p className="text-[1.0625rem] sm:text-lg text-[color:var(--color-secondary-label)] leading-relaxed max-w-lg mx-auto mb-8">
      ...
      <section className="px-5 pb-10">
        <div className="max-w-xl mx-auto">
          <div className="bg-white rounded-3xl p-6 sm:p-8 text-center">
            ...
            <cite className="not-italic text-[0.875rem] text-[color:var(--color-secondary-label)] font-medium">{verse.ref}</cite>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-16 px-5">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-[1.75rem] sm:text-[2.125rem] font-bold tracking-tight text-[color:var(--color-label)]">Everything you need to study</h2>
            <p className="text-[color:var(--color-secondary-label)] mt-2 text-base">Simple tools for deeper understanding.</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-7">
              ...
              <h3 className="text-[1.0625rem] font-semibold text-[color:var(--color-label)] mb-1.5">Three Translations</h3>
              <p className="text-[0.9375rem] text-[color:var(--color-secondary-label)] leading-relaxed">
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-7">
              ...
              <h3 className="text-[1.0625rem] font-semibold text-[color:var(--color-label)] mb-1.5">Study Guides</h3>
              <p className="text-[0.9375rem] text-[color:var(--color-secondary-label)] leading-relaxed">
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-7">
              ...
              <h3 className="text-[1.0625rem] font-semibold text-[color:var(--color-label)] mb-1.5">Topics & Answers</h3>
              <p className="text-[0.9375rem] text-[color:var(--color-secondary-label)] leading-relaxed">
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-7">
              ...
              <h3 className="text-[1.0625rem] font-semibold text-[color:var(--color-label)] mb-1.5">Free Forever</h3>
              <p className="text-[0.9375rem] text-[color:var(--color-secondary-label)] leading-relaxed">
      ...
      <section className="py-10 px-5">
        <div className="max-w-xl mx-auto text-center mb-8">
          <h2 className="text-[1.75rem] sm:text-[2.125rem] font-bold tracking-tight text-[color:var(--color-label)]">Start here</h2>
          <p className="text-[color:var(--color-secondary-label)] mt-2">Pick a book that interests you.</p>
        </div>
      ...
      <section className="py-12 sm:py-16 px-5">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-[1.75rem] sm:text-[2.125rem] font-bold tracking-tight text-[color:var(--color-label)]">Browse the Bible</h2>
            <p className="text-[color:var(--color-secondary-label)] mt-2">All 72 books across 8 translations.</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className="space-y-5">
                {otGroups.map(group => (
                  <div key={group.label}>
                    <p className="text-[0.6875rem] font-semibold uppercase tracking-wider text-[color:var(--color-tertiary-label)] mb-2.5 px-1">{group.label}</p>
            ...
            <div>
              <div className="flex items-center gap-2.5 mb-5">
                ...
                <span className="text-[0.75rem] text-[color:var(--color-tertiary-label)]">27 books</span>
              </div>
              <div className="space-y-5">
                {ntGroups.map(group => (
                  <div key={group.label}>
      ...
      <section className="py-12 sm:py-16 px-5">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-end justify-between mb-6">
            <div>
              <h2 className="text-[1.75rem] sm:text-[2.125rem] font-bold tracking-tight text-[color:var(--color-label)]">Topics</h2>
              <p className="text-[color:var(--color-secondary-label)] mt-1">What the Bible says about what matters most.</p>
            </div>
            <Link href="/topics" className="text-[0.875rem] font-medium text-[color:var(--color-primary)] hover:underline whitespace-nowrap hidden sm:block">
              See all
            </Link>
          </div>
          ...
          <div className="text-center mt-4 sm:hidden">
            <Link href="/topics" className="text-[0.875rem] font-medium text-[color:var(--color-primary)]">See all topics</Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-16 px-5">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-8">
            <h2 className="text-[1.75rem] sm:text-[2.125rem] font-bold tracking-tight text-[color:var(--color-label)]">Common Questions</h2>
            ...
            {questions.map((q, i) => (
              ...
              >
                <div className="flex-1 min-w-0">
                  <h3 className="text-[0.9375rem] font-medium text-[color:var(--color-label)] group-hover:text-[color:var(--color-primary)] transition-colors">{q.question}</h3>
                  <p className="text-[0.8125rem] text-[color:var(--color-tertiary-label)] mt-0.5 truncate">{q.excerpt}</p>
                </div>
                <svg className="w-4 h-4 text-[color:var(--color-tertiary-label)] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M9 5l7 7-7 7" /></svg>
              </Link>
            ))}
          </div>

          <div className="text-center mt-4">
            <Link href="/questions" className="text-[0.875rem] font-medium text-[color:var(--color-primary)] hover:underline">
              See all questions
            </Link>
          </div>
        </div>
