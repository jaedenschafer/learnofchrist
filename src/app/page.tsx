          ...
          <div className="space-y-3">
            <Link href="/bible" className="card flex items-start gap-4 group">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="font-sans text-base font-semibold text-navy mb-0.5 group-hover:text-gold transition-colors">Chapter-by-Chapter Guides</h3>
                <p className="text-sm text-navy/50 leading-relaxed">Navigate every chapter with overviews, themes, and reflections.</p>
              </div>
