...
export default function TranslationsPage() {
  ...
  return (
    <main className="loct">
      ...
      <section className="lop-hero">
        ...
        <div className="lop-wrap lop-hero__inner">
          <div className="lop-hero__pane">
            <p className="lop-eyebrow">Translations</p>
            ...
            <div className="lop-hero__chips">
              <span className="lop-hero__chip">{translations.length} translations</span>
              <span className="lop-hero__chip-sep" aria-hidden="true">·</span>
              <span className="lop-hero__chip">All free, all online</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="lop-grid-section">
