...
const TINTS: Record<string, { bg: string; pill: string; accent: string }> = {
  blue: { bg: 'from-[var(--vesper-gold)]/[0.08] to-[var(--vesper-gold)]/[0.02]', pill: ' text-[color:var(--color-primary)]', accent: 'text-[color:var(--color-primary)]' },
  ...
  purple: { bg: 'from-[var(--vesper-gold)]/[0.08] to-[var(--vesper-gold)]/[0.02]', pill: ' text-[color:var(--vesper-gold)]', accent: 'text-[color:var(--vesper-gold)]' },
        ...
        <section className="hero-surface relative mb-10 overflow-hidden rounded-[32px]">
          ...
          <div className="relative px-4 sm:px-10 py-8 sm:py-14 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-2.5 justify-center mb-8">
              <Link
                href="/study/john/1"
                className="btn-primary shadow-[0_1px_2px_rgba(88,86,214,0.2),0_4px_12px_rgba(88,86,214,0.2)]"
              >
                Start with John 1
