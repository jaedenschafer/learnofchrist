...
export const FIRST_ESDRAS_4: RichChapterContent = {
  ...
  youth: {
    intros: [
      "Zerubbabel argues that TRUTH is strongest. He wins. Truth conquers wine, kings, women, and everything else. &ldquo;Great is truth, and mighty above all things.&rdquo; The line still rings.",
    ],
  },
  intros: [
