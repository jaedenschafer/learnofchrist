    ...
    /* ─── 1 Samuel 29:1–2 — The Armies Marshal ──────────────────────── */
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          id: 'c-aphek',
          html:
            'Aphek lies on the northern plain, a strategic position for the Philistines to stage their forces. This is the moment of maximum danger for Israel and for David. The armies are gathered, and David is marching with them.[res:sefaria-hannah-prayer][res:bible-odyssey-eli][res:iaa-shiloh]',
        },
        {
          kind: 'commentary',
          id: 'c-jezreel',
