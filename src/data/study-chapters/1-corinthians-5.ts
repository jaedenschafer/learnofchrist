...
export const FIRST_CORINTHIANS_5: RichChapterContent = {
  ...
  youth: {
    intros: [
      "The church is tolerating sexual immorality. Paul commands them to remove the unrepentant member. &ldquo;A little leaven leaveneth the whole lump.&rdquo; Discipline is part of love.",
    ],
  },
  intros: [
