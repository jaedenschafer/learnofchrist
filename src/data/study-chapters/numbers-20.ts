...
export const NUMBERS_20: RichChapterContent = {
  ...
  youth: {
    intros: [
      "The water runs out at Kadesh. Israel grumbles AGAIN. God tells Moses: SPEAK to the rock. Moses, fed up with forty years of complaining, STRIKES it twice with his staff. Water comes. But Moses&apos; punishment: he won&apos;t enter the promised land.",
      "Even Moses — the greatest leader in the OT — disqualified himself from the promised land in one moment of disobedience. Be careful at the end of long faithful chapters. Don&apos;t let frustration with the people you&apos;re leading cost you what God meant to give.",
    ],
  },
  intros: [
