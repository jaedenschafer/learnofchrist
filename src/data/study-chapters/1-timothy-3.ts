...
export const FIRST_TIMOTHY_3: RichChapterContent = {
  ...
  youth: {
    intros: [
      "Qualifications for elders and deacons. Above reproach, husband of one wife, sober, hospitable, able to teach. The character of leaders matters more than their gifts.",
    ],
  },
  intros: [
