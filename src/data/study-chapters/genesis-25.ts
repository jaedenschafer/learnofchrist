  ...
  sections: [
    ...
    /* ─── Genesis 25:12-18 - Ishmael's Genealogy and Death ───────────────── */
    {
      ...
      blocks: [
        ...
        {
          kind: 'commentary',
          id: 'genesis-25-78mid-1',
          html: 'Abraham breathes his last, his story complete. Isaac and Ishmael bury him together, and then we turn to Ishmael&apos;s line-thirteen sons, growing mighty.',
        },
        {
          kind: 'scripture',
          chapter: 25,
    ...
    /* ─── Genesis 25:19-26 - Rebekah Barren; Twins in the Womb ──────────── */
    {
      ...
      blocks: [
        ...
        {
          kind: 'commentary',
          id: 'genesis-25-78mid-2',
          html: 'Rebekah&apos;s womb churns with two nations at war. Jacob comes second, gripping his brother&apos;s heel-even at birth, he reaches for the birthright.',
        },
        {
          kind: 'scripture',
          chapter: 25,
          lines: [
            {
              ...
              spans: [
                ...
                t('elder shall serve the younger'),
                t('.'),
              ],
            },
            {
            ...
            },
            {
              ...
              spans: [
                ...
                t('red, all over like an hairy garment'),
    ...
    /* ─── Genesis 25:27-34 - Esau Sells His Birthright ─────────────────── */
    {
      ...
      blocks: [
        ...
        {
          kind: 'commentary',
          id: 'genesis-25-78mid-3',
          html: 'The boys grow: Esau a hunter, Jacob a tent dweller. One day, Esau returns famished, and in a moment of hunger he trades his inheritance for a bowl.',
        },
        {
          kind: 'scripture',
          chapter: 25,
