    ...
    /* ─── Jeremiah 44:1–14 — The Charge Against Idolatry ──────────────── */
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          id: 'jer44-prophets',
          html:
            'God recalls His persistent patience. He sent prophet after prophet. He rose early—the image is of a parent rising before the sun, desperate and earnest. And what was the message? Simple and direct: "Do not this abominable thing that I hate." The word "abominable" (toeevah in Hebrew) is the strongest language of revulsion. This is not a minor transgression. This is what God, in His holy nature, cannot tolerate. Yet the people heard the warning and did it anyway.',
        },
        {
          kind: 'commentary',
          id: 'jer44-provoke',
          html:
            'The remnant have done more than sin. They have provoked God to anger through the works of their own hands. They think they are safe in Egypt, but they are actually cutting themselves off—severing themselves from the God who sought to protect them. By worshipping other gods in the land of Egypt, they are making themselves a curse and a reproach among all nations. Their own choice transforms them from God&apos;s people into a byword of judgment.',
        },
        {
          kind: 'carry',
          html:
            'This passage presents a haunting truth: we cannot outrun our idolatry by changing location. The remnant fled Jerusalem thinking geography would save them. But the same divided heart that led them astray in Judah leads them astray in Egypt. What captures your devotion follows you wherever you go. Only a change of heart—a turning from what you worship to the worship of God alone—can save you.',
        },
        {
          kind: 'reflection',
          id: 'jer44-what-queen',
