...
export const NUMBERS_2: RichChapterContent = {
  ...
  youth: {
    intros: [
      "Israel pitches camp around the tabernacle in a perfect square — three tribes on each side, the tabernacle in the middle. The arrangement preaches: God is the center. Every tribe&apos;s direction is determined by where God is.",
      "Whatever you organize your week around — that&apos;s your tabernacle. Move the actual tabernacle to the center and watch the tribes (your time, your friends, your priorities) start to fall in around it.",
    ],
  },
  intros: [
