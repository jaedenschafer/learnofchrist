...
export const LEVITICUS_25: RichChapterContent = {
  ...
  estimatedMinutes: { beginner: 13, intermediate: 20, deep: 24 },

  youth: {
    intros: [
      "Every seven years the land rests. Every fifty years — the Jubilee — debts are wiped, slaves are freed, ancestral land returns to its original family. A reset built into the economy of Israel.",
      "Jesus opens His ministry in Luke 4 quoting Isaiah about &ldquo;the acceptable year of the Lord&rdquo; — Jubilee language. He IS Jubilee. Whatever you owe, whatever you&apos;ve been enslaved to, whatever inheritance you forfeited — He&apos;s come to release you.",
    ],
  },
  intros: [
