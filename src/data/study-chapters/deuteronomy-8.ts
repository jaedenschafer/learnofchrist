          ...
          lines: [
            {
              ...
              spans: [
                ...
                hy('all the way which the Lord thy God led thee', 'dt8-remember'),
          ...
          lines: [
            {
              ...
              spans: [
                ...
                hp('man doth not live by bread only', 'dt8-manna-word'),
                t(', but by '),
                hp('every word that proceedeth out of the mouth of the Lord', 'dt8-manna-word'),
                t(' doth man live.'),
              ],
            },
          ],
          ...
          lines: [
            {
              ...
              spans: [
                t('A land of '),
                hy('wheat, and barley', 'dt8-crops'),
                t(', and vines, and fig trees, and pomegranates; a land of '),
                hy('oil olive, and honey', 'dt8-oil-honey'),
                t(';'),
              ],
            },
          ],
          ...
          lines: [
            {
              ...
              spans: [
                ...
                hp('manna which thy fathers knew not', 'dt8-manna-again'),
