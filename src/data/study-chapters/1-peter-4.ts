...
export const FIRST_PETER_4: RichChapterContent = {
  ...
  youth: {
    intros: [
      "Christ suffered in the flesh; arm yourself with the same mind. The end of all things is at hand: be sober, watch unto prayer. Above all, have fervent charity. Don&apos;t be surprised at fiery trials.",
    ],
  },
  intros: [
