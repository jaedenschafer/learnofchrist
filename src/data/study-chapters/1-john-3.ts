...
export const FIRST_JOHN_3: RichChapterContent = {
  ...
  youth: {
    intros: [
      "Behold what manner of love the Father has bestowed on us — that we should be called sons of God. Whoever is born of God doesn&apos;t practice sin. Love one another in deed and in truth, not just in word.",
    ],
  },
  intros: [
