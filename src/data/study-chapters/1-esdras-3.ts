...
export const FIRST_ESDRAS_3: RichChapterContent = {
  ...
  youth: {
    intros: [
      "A famous scene: three young bodyguards of King Darius write essays on what is strongest in the world — wine, kings, women, and TRUTH. The contest is launched.",
    ],
  },
  intros: [
