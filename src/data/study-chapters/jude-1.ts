...
export const JUDE_1: RichChapterContent = {
  ...
  youth: {
    intros: [
      "A short letter warning against false teachers who crept in unawares. &ldquo;Earnestly contend for the faith.&rdquo; The closing benediction: &ldquo;Now unto him that is able to keep you from falling, and to present you faultless before the presence of his glory with exceeding joy.&rdquo;",
    ],
  },
  intros: [
