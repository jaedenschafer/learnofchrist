...
export const SECOND_CORINTHIANS_11: RichChapterContent = {
  ...
  youth: {
    intros: [
      "Paul reluctantly boasts — listing his sufferings: imprisonments, beatings, near deaths, shipwrecks, robbers, weariness, hunger. The cost of being an apostle. Don&apos;t romanticize the calling.",
    ],
  },
  intros: [
