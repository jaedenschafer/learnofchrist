  ...
  sections: [
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          id: 'ezk2-son-of-man',
          html:
            'The term "son of man" is not glorifying. It means "mortal," "son of Adam." It is the gap between Ezekiel and the God who addresses him — infinite. Yet God narrows that gap by speaking to him, by entering his spirit, by setting him on his feet. The human becomes capable of standing only by the grace of God entering him.',
        },
        {
          kind: 'hebrew',
          id: 'ezk2-ben-adam',
...

    {
      ...
      blocks: [
        ...
        },
        {
          ...
          html:
            'John declares: "The Word was made flesh, and dwelt among us." God did not merely write a message and send it. God became the message. Christ is the scroll eaten and internalized — not merely preached but lived, embodied, given to the world as His own flesh and blood. To follow Christ is to eat the scroll, to make His word so much our own that it becomes the substance of our being.',
        },
        {
          kind: 'carry',
          html:
            'The scroll Ezekiel eats tastes of sorrow, loss, and judgment. Yet the message of judgment is itself an act of love — God breaking His silence about unfaithfulness, calling the exiles back toward truth. To eat such a scroll is to accept a burden. But it is also to participate in God&apos;s work of redemption.',
        },
        {
          kind: 'reflection',
