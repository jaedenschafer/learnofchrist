  ...
  sections: [
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          html: 'The elders sit before Ezekiel, but their hearts are not with Ezekiel&apos;s God. Their idols are set up in their hearts. They ask for a word, but not a word that would require them to abandon what they love. God responds to their question by answering according to the multitude of their idols. In other words, God meets them where they actually are — holding both the false gods and their desire for a word from the true God. The answer will be judgment[res:babylonian-exile-context].',
        },
        {
          kind: 'hebrew',
          id: 'ezk14-pesel-lev',
        ...
        {
          kind: 'carry',
          html: 'We too can come to God while holding idols in our hearts. We can seek His word while refusing to abandon what we love more than Him. We can ask for guidance while unwilling to follow it if it requires sacrifice. God sees the idols enshrined within us. He does not accept worship that is divided[res:sefaria-ezekiel].',
        },
        {
          kind: 'reflection',
          id: 'ezk14-idols-held',
