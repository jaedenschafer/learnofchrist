...
export const JOSHUA_7: RichChapterContent = {
  ...
  youth: {
    intros: [
      "Israel gets routed at the small city of Ai. Why? One man — Achan — secretly took spoils from Jericho he was forbidden to take. The whole army loses because of one private sin.",
      "Sin you think is hidden affects more than you. Your private compromise affects your family, your team, your church. Bring it to the light before it costs everyone around you a battle.",
    ],
  },
  intros: [
