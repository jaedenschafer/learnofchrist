...
export const ROMANS_9: RichChapterContent = {
  ...
  youth: {
    intros: [
      "Paul&apos;s anguish for his Jewish brothers. Then a long meditation on God&apos;s sovereign election. &ldquo;Hath not the potter power over the clay?&rdquo; The hardest theological chapter in the Bible. Lean in.",
    ],
  },
  intros: [
