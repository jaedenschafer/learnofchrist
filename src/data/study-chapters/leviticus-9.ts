    ...
    /* ─── Leviticus 9:23 — Into the Tabernacle ─────────────────────────── */
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          html:
            '[res:sbl-eighth-day-resurrection] Hebrews 9:11–12 says Christ &ldquo;entered in once into the holy place by his own blood, having obtained eternal redemption.&rdquo; Christ ascended. He went into the heavenly tabernacle alone, carrying His own blood. Then He sent His Spirit. [res:intertextual-pentecost-fire] The fire that fell at Pentecost — &ldquo;cloven tongues like as of fire&rdquo; (Acts 2:3) — is Leviticus 9 fulfilled. The glory has appeared. The fire has fallen. The blessing has been spoken. All the people see it.',
        },
        {
          kind: 'carry',
          html:
  ...
  resources: [
    {
      ...
      kind: 'archive',
      source: 'Sefaria',
      label: 'The Eighth Day in Rabbinical Tradition',
      url: 'https://www.sefaria.org/Leviticus.9',
      description: 'Rabbinic commentary on the eighth day and its eschatological significance.',
    },
    {
      id: 'intertextual-pentecost-fire',
      kind: 'study',
