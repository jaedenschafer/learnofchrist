...
export const EPHESIANS_2: RichChapterContent = {
  ...
  estimatedMinutes: { beginner: 8, intermediate: 18, deep: 25 },

  youth: {
    intros: [
      "You were dead in trespasses and sins. But God, who is rich in mercy, made you alive together with Christ. By grace you are saved through faith — not of works. Then the wall between Jew and Gentile is broken down. One new man in Christ.",
    ],
  },
  intros: [
