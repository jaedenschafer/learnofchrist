          ...
          lines: [
            {
              ...
              spans: [
                ...
                hg('burn thine house upon thee with fire', 'judges12-burn'),
                t('.'),
              ],
            },
          ],
          ...
          lines: [
            {
              ...
              spans: [
                ...
                hg('to fight against me', 'judges12-fight-me'),
                t('?'),
              ],
            },
          ],
          ...
          lines: [
            {
              ...
              spans: [
                ...
                hg('seven years', 'judges12-ibzan-years'),
                t('.'),
              ],
            },
          ],
          ...
          lines: [
            {
              ...
              spans: [
                ...
                hg('eight years', 'judges12-abdon-years'),
                t('.'),
              ],
            },
          ],
