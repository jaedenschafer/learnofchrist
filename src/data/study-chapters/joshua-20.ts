          ...
          lines: [
            ...
            },
            {
              ...
              spans: [
                ...
                hg('Bezer in the wilderness upon the plain of the tribe of Reuben', 'c-bezer'),
                t(', and '),
                hg('Ramoth in Gilead out of the tribe of Gad', 'c-ramoth'),
                t(', and '),
                hg('Golan in Bashan out of the tribe of Manasseh', 'c-golan'),
                t('.'),
              ],
            },
          ],
