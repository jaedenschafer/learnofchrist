...
export const SECOND_ESDRAS_7: RichChapterContent = {
  ...
  youth: {
    intros: [
      "Ezra&apos;s long debate with Uriel about the few who are saved versus the many who perish. The chapter is among the most intense theological passages in the apocrypha.",
    ],
  },
  intros: [
