...
export const REVELATION_2: RichChapterContent = {
  ...
  youth: {
    intros: [
      "Letters to four churches: Ephesus (lost first love), Smyrna (faithful in suffering), Pergamum (compromise), Thyatira (tolerated false prophetess). To him that overcometh.",
    ],
  },
  intros: [
