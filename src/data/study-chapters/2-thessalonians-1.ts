...
export const SECOND_THESSALONIANS_1: RichChapterContent = {
  ...
  youth: {
    intros: [
      "When the Lord Jesus shall be revealed from heaven with His mighty angels, in flaming fire, taking vengeance on those who don&apos;t know God. Comfort for the persecuted: Christ is coming.",
    ],
  },
  intros: [
