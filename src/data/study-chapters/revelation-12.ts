...
export const REVELATION_12: RichChapterContent = {
  ...
  youth: {
    intros: [
      "A woman clothed with the sun. A great red dragon. The dragon thrown out of heaven. War in heaven. Michael fights the dragon. The accuser of the brethren is cast down.",
    ],
  },
  intros: [
