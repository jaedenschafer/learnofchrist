...
/**
 * Joshua 18 — Shiloh, the Land Surveyed, Casting Lots, Benjamin[res:sefaria-benjamin-saul-paul][res:bibleodyssey-benjamin-territory]'s Territory
 *
  ...
  resources: [
    {
      ...
      kind: 'study',
      source: 'Sefaria',
      label: 'Benjamin: From Small Tribe to Kingdom Builders',
      url: 'https://www.sefaria.org/Joshua.18?lang=bi',
      description: 'The historical trajectory of the tribe of Benjamin, which produced both Saul the first king and Saul (Paul) the apostle.',
    },
    {
      id: 'intertextual-smallness-to-significance',
      kind: 'study',
      source: 'Intertextual Bible',
      label: 'God&apos;s Work Through Smallness (Benjamin to Paul)',
      url: 'https://intertextual.bible/search?q=benjamin+small+weak+strong+paul+2+corinthians',
      description: 'The pattern of God working through those who are small and weak, from Benjamin&apos;s limited territory to Paul&apos;s declaration of strength in weakness.',
    },
  ],
