...
export const COLOSSIANS_1: RichChapterContent = {
  ...
  youth: {
    intros: [
      "Christ is the image of the invisible God, the firstborn over all creation. By Him all things were created. He is before all things; in Him all things hold together. He is the head of the body, the church.",
    ],
  },
  intros: [
