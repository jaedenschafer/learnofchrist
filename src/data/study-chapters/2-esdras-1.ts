...
export const SECOND_ESDRAS_1: RichChapterContent = {
  ...
  youth: {
    intros: [
      "God&apos;s message to Ezra: Israel has rejected Him; He will turn to other nations. The opening chapter of an apocalyptic book that wrestles with God&apos;s justice.",
    ],
  },
  intros: [
