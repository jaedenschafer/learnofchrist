...
export const DEUTERONOMY_24: RichChapterContent = {
  ...
  youth: {
    intros: [
      "Don&apos;t take a millstone as collateral on a loan — that&apos;s how the family makes bread. Pay your worker the same day. Don&apos;t pervert justice for the stranger, the fatherless, or the widow. Leave gleanings in the field for the poor.",
      "God wrote economic mercy into Israel&apos;s law. Whatever financial decisions you&apos;ll make in your life — the way you tip, the way you pay people who work for you, the way you give — read this chapter as a checklist.",
    ],
  },
  intros: [
