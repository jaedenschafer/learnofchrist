...
export const PSALM_151_1: RichChapterContent = {
  ...
  youth: {
    intros: [
      "A short autobiographical psalm attributed to David: &ldquo;I was small among my brethren, and youngest in my father&apos;s house: I tended my father&apos;s sheep.&rdquo; The shepherd-king&apos;s testimony in his own voice.",
    ],
  },
  intros: [
