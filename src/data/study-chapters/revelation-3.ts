...
export const REVELATION_3: RichChapterContent = {
  ...
  youth: {
    intros: [
      "Three more letters: Sardis (dead), Philadelphia (open door), Laodicea (lukewarm). &ldquo;Behold, I stand at the door, and knock: if any man hear my voice, and open the door, I will come in to him.&rdquo;",
    ],
  },
  intros: [
