  ...
  sections: [
...

    {
      ...
      blocks: [
        ...
        {
          kind: 'commentary',
          id: 'resolve-redeemed-called-2',
          html:
            '<p>I make a way in the desert, rivers in the wasteland. My people drink; My chosen are refreshed.</p>',
        },
        {
          kind: 'scripture',
          chapter: 43,
        ...
        {
          kind: 'commentary',
          id: 'resolve-redeemed-called-3',
          html:
            '<p>You have wearied God with your sins; He is weary of bearing them. Yet He, even He, blots them out.</p>',
        },
        {
          kind: 'scripture',
          chapter: 43,
