    ...
    /* ─── Genesis 9:1-7 - The Renewed Creation Mandate ──────────────────── */
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          description: 'Blood cannot be eaten because blood is life. The Israelites will hear this prohibition over and over (Lev. 3:17, 7:26). The blood of sacrifice will become the sign of covenant. And in the New Testament, Christ\'s blood - poured out, never eaten carelessly - becomes the cost of redemption.',
        },
        {
          kind: 'commentary',
    ...
    /* ─── Genesis 9:8-17 - The Covenant and the Bow ──────────────────────── */
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          description: 'The same Hebrew word means both the weapon of war - an archer\'s bow - and the rainbow in the sky. God takes His war-bow and hangs it in the cloud pointing upward, away from the earth. The instrument of judgment is pointed toward heaven now, not toward us.',
        },
        {
          kind: 'commentary',
          id: 'c-bow-means',
          html: 'The Hebrew is stunning. God puts <em>His bow</em> in the sky. The bow that shoots arrows of judgment is hung up -- pointed away. Every time the sky fills with water and light, the covenant appears. God will remember. The flood will not come again.',
        },
        {
          kind: 'scripture',
          chapter: 9,
