...
export const HEBREWS_3: RichChapterContent = {
  ...
  youth: {
    intros: [
      "Christ is greater than Moses. Today, if you hear His voice, harden not your hearts. Israel didn&apos;t enter rest because of unbelief. Don&apos;t miss the rest now offered to you.",
    ],
  },
  intros: [
