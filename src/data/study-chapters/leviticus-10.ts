    ...
    /* ─── Leviticus 10:3 — And Aaron Held His Peace ───────────────────── */
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          html:
            'Aaron&apos;s silence is echoed in one other moment in the Gospels. At the foot of the cross, Mary stands and says nothing. John 19:25 names her there: &ldquo;Now there stood by the cross of Jesus his mother&rdquo; — present, witnessing, <em>silent.</em> Not because she understood the theology. Not because she had accepted it. But because in the presence of something so grievous and so holy at once, what can a mother say? Christ&apos;s death is the ultimate strange fire — God&apos;s own Son, in God&apos;s own temple, doing something that looks wrong until you see it is exactly right. And the ones who stand closest do not rage or explain. They hold their peace.',
        },
        {
          kind: 'carry',
          html:
