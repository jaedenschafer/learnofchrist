  ...
  sections: [
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          title: 'Mayim — "Waters"',
          script: 'מַיִם',
          translit: '<strong>Mayim</strong> · waters; life-giving waters',
          description: 'Water is the symbol of the life and sustenance God freely offers.',
        },
        {
          kind: 'scripture',
          chapter: 55,
