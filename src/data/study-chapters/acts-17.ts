  ...
  resources: [
    {
      ...
      description: 'Open-access SBL entry on the limestone outcrop where Paul addressed the philosophers, covering both the site and the council.',
    },
    {
      id: 'ascsa-agora',
      kind: 'archaeology',
      ...
      description: 'Continuous excavation of the marketplace below the Areopagus since 1931 — the temples, altars and shrines Acts describes.',
    },
    {
      ...
      description: 'Full Greek + English of the Stoic poem Paul quotes at Acts 17:28 — line 5 of the proem.',
    },
    {
      ...
      description: 'Side-by-side comparison of Aratus&apos;s Greek and Paul&apos;s Greek, showing how the citation works.',
    },
  ],
