...
export const HEBREWS_5: RichChapterContent = {
  ...
  estimatedMinutes: { beginner: 6, intermediate: 10, deep: 16 },

  youth: {
    intros: [
      "Christ became the author of eternal salvation to all who obey Him. He&apos;s a priest after the order of Melchizedek. The audience needs milk; they should be ready for meat.",
    ],
  },
  intros: [
