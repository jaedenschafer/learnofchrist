...
export const JAMES_2: RichChapterContent = {
  ...
  youth: {
    intros: [
      "Don&apos;t show favoritism between rich and poor in church. Faith without works is dead. Even the demons believe — and tremble. Real faith shows up in how you treat people.",
    ],
  },
  intros: [
