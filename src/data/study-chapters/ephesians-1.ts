...
export const EPHESIANS_1: RichChapterContent = {
  ...
  youth: {
    intros: [
      "Blessed be the God and Father of our Lord Jesus Christ, who has blessed us with every spiritual blessing in Christ. Chosen before the foundation of the world. Predestined to adoption. Sealed with the Holy Spirit. The bookend praises in this chapter run breathless.",
    ],
  },
  intros: [
