...
export const SAMUEL_1_13: RichChapterContent = {
  ...
  characters: [
    ...
    { slug: 'jonathan', role: 'Strikes the Philistine garrison at Geba' },
  ],
  intros: [
          ...
          lines: [
            ...
            },
            {
              ...
              spans: [
                ...
                t('I forced myself therefore, and offered a burnt offering'),
                t('.'),
              ],
            },
          ],
          ...
          lines: [
            {
              ...
              spans: [
                ...
                t('captain over his people, because thou hast not kept that which the Lord commanded thee'),
                t('.'),
              ],
            },
          ],
