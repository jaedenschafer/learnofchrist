...
export const RUTH_4: RichChapterContent = {
  ...
  youth: {
    intros: [
      "Boaz settles the legal stuff at the city gate. There&apos;s a closer relative who has first rights — but he passes. Boaz redeems Ruth and the land. They marry. Ruth has a son named Obed.",
      "Obed becomes the father of Jesse, the father of David, the line of Jesus. A foreign widow&apos;s yes in chapter 1 ends up in the genealogy of Christ. God writes the most surprising people into His story. Yours included.",
    ],
  },
  intros: [
