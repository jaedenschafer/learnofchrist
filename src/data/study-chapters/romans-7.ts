...
export const ROMANS_7: RichChapterContent = {
  ...
  youth: {
    intros: [
      "The famous chapter on inner conflict. &ldquo;The good that I would I do not: but the evil which I would not, that I do.&rdquo; Then the cry: &ldquo;O wretched man that I am! who shall deliver me?&rdquo; The answer: Jesus Christ our Lord.",
    ],
  },
  intros: [
