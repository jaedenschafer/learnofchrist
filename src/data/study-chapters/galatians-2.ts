...
export const GALATIANS_2: RichChapterContent = {
  ...
  youth: {
    intros: [
      "Paul confronts Peter to his face for compromising on the gospel for the Gentiles. &ldquo;I am crucified with Christ: nevertheless I live; yet not I, but Christ liveth in me.&rdquo;",
    ],
  },
  intros: [
