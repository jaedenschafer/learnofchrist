...
export const LEVITICUS_16: RichChapterContent = {
  ...
  youth: {
    intros: [
      "The Day of Atonement. Once a year the high priest enters the Holy of Holies — the only person allowed, the only day. Two goats: one is sacrificed, one is sent into the wilderness carrying the sins of the nation on its head. Both pictures of Christ.",
      "Hebrews 9 makes the connection: Jesus entered the heavenly Holy of Holies once for all, with His own blood. You don&apos;t wait for an annual atonement. You live inside the finished one.",
    ],
  },
  intros: [
