...
export const ACTS_28: RichChapterContent = {
  ...
  map: {
    ...
    places: [
      { name: 'Malta', x: 0.39, y: 0.5, kind: 'origin', note: 'Three months on the island' },
      { name: 'Syracuse', x: 0.41, y: 0.49, kind: 'visit' },
      { name: 'Puteoli', x: 0.36, y: 0.43, kind: 'visit' },
      { name: 'Rome', x: 0.32, y: 0.42, kind: 'travel-to', note: '"Unto the uttermost part of the earth"' },
    ],
    route: [0, 1, 2, 3],
    caption: 'The last leg: Malta → Syracuse → Puteoli → Rome. The book ends with the gospel "no man forbidding."',
  },
  intros: [
