...
export const SECOND_ESDRAS_3: RichChapterContent = {
  ...
  estimatedMinutes: { beginner: 12, intermediate: 18, deep: 24 },

  youth: {
    intros: [
      "Ezra prays in the spirit of Job: why does evil prosper? Why has Israel suffered? The book&apos;s long theological wrestle begins.",
    ],
  },
  intros: [
