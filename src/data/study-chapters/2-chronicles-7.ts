          ...
          lines: [
            ...
            },
            {
              ...
              spans: [
                ...
                hp('humble themselves', 'if-my-people-humble'),
                t(', and '),
                hp('pray', 'if-my-people-pray'),
                t(', and '),
                hp('seek my face', 'if-my-people-seek'),
                t(', and '),
                hp('turn from their wicked ways', 'if-my-people-turn'),
                t('; then will I '),
                hp('hear from heaven', 'if-my-people-hear'),
                t(', and will '),
                hp('forgive their sin', 'if-my-people-forgive'),
                t(', and will '),
                hp('heal their land', 'if-my-people-heal'),
                t('.'),
              ],
            },
